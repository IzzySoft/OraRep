...
<TABLE WIDTH="95%" ALIGN="center"><TR><TD>
 ...
 <TABLE ALIGN="center" WIDTH="95%" BORDER="1">
  ...
  <TR><TD>Segment</TD><TD>The segments name</TD></TR>
  <TR><TD>Status</TD><TD>Whether this segment is currently available
      (<CODE>ONLINE</CODE>) or not</TD></TR>
  <TR><TD>Size</TD><TD>The actual size of this segment</TD></TR>
  <TR><TD>OptSize</TD><TD>The optimal size of this segment as defined at
      creation of the segment or with the <CODE>ALTER</CODE> command at a later
      time</TD></TR>
  <TR><TD>HWMSize</TD><TD>Size reached by the largest transaction we've had</TD></TR>
  ...
  <TR><TD>XActs</TD><TD>current transactions</TD></TR>
  <TR><TD>Shrinks</TD><TD>Number of growth beyond the <CODE>OPTIMAL<CODE> value
      (see OptSize in this table) that have been shrunk afterwards</TD></TR>
  <TR><TD>Wraps</TD><TD>Wraps occur whenever a new extent is needed but the
      ...
      occured.</TD></TR>
  <TR><TD>AveShrink</TD><TD>Average amount that this RBS has been shrunk</TD></TR>
  <TR><TD>AveActive</TD><TD>Average transaction size for this RBS</TD></TR>
 </TABLE>
