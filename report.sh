...
# ====================================================[ Script starts here ]===
#cat $SQLSET $BINDIR/rephead.pls $PLUGINDIR/formatting.pls $WTEVTHEAD $WAITHEAD $ENQHEAD $SPADVHEAD $RSRCHEAD $PROFHEAD $TSQUOTHEAD $FILESHEAD $RBSHEAD $MEMVALHEAD $POOLHEAD $BUFFRATHEAD $FLCHEAD $BINDIR/repopen.pls $RSRCBODY $PROFBODY $TSQUOTBODY $FILESBODY $RBSBODY $MEMVALBODY $POOLBODY $TMPADV $SYSSTAT $WTEVTBODY $BUFFRATBODY $FLCBODY $WAITBODY $ENQBODY $BINDIR/repclose.pls >rep.out
cat $SQLSET $BINDIR/rephead.pls $PLUGINDIR/formatting.pls $WTEVTHEAD $WAITHEAD $ENQHEAD $SPADVHEAD $RSRCHEAD $PROFHEAD $TSQUOTHEAD $FILESHEAD $RBSHEAD $MEMVALHEAD $POOLHEAD $BUFFRATHEAD $FLCHEAD $BINDIR/repopen.pls $RSRCBODY $PROFBODY $TSQUOTBODY $FILESBODY $RBSBODY $MEMVALBODY $POOLBODY $TMPADV $SYSSTAT $WTEVTBODY $BUFFRATBODY $FLCBODY $WAITBODY $ENQBODY $BINDIR/repclose.pls | $ORACLE_HOME/bin/sqlplus -s /NOLOG
